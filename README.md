...
A chat application written using Ruby and Ruby-on-Rails framework that utilizes ActionCable(Websocket) technology o achieve real-time stream of data transfer. Users are able to communicate with each other preserving their conversation and able to search for other available users of the application.
